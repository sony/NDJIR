...
import grid_feature.lanczos_voxel_hash_feature
import nnabla as nn
import nnabla.functions as F
import numpy as np
import pytest
from grid_feature.lanczos_voxel_hash_feature_composite import \
...
def test_query_on_voxel_hash_forward_backward(seed, batch_size, 
    ...
    feature1 = nn.parameter.get_parameter_or_create("F1", (n_params, ),
                                                          initializer_data1)
    output1 = F.lanczos_query_on_voxel_hash(query1, feature1, 
                                    G0, growth_factor, T0, L, D, 
                                    [m] * 3, [M] * 3)
